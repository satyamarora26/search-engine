...
class WikipediaCrawlRun(Base):
    __tablename__ = "wikipedia_crawl_runs"
    __table_args__ = (
        CheckConstraint(
    ...
    root_category: Mapped[str] = mapped_column(Text, nullable=False)
    ...
    category_limit_reached: Mapped[bool] = mapped_column(
        Boolean,
        nullable=False,
        server_default="false",
    )
...
class WikipediaCrawlFrontier(Base):
    __tablename__ = "wikipedia_crawl_frontier"
    __table_args__ = (
        UniqueConstraint(
            "job_id",
            "category_title",
    ...
    job_id: Mapped[UUID] = mapped_column(
        PostgreSQLUUID(as_uuid=True),
        ForeignKey("wikipedia_crawl_runs.job_id", ondelete="CASCADE"),
        nullable=False,
    )
...
class WikipediaCrawlPage(Base):
    __tablename__ = "wikipedia_crawl_pages"
    __table_args__ = (
        UniqueConstraint(
            "job_id",
            "position",
    ...
    wikipedia_page_id: Mapped[int] = mapped_column(BigInteger, nullable=False)
